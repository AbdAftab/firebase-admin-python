...
def send_each(messages, dry_run=False, app=None, use_http2=False):
    ...
    Args:
        ...
        dry_run: A boolean indicating whether to run the operation in dry run mode (optional).
        app: An App instance (optional).
        use_http2: A boolean indicating whether to use HTTP/2 for the request (optional).
    ...
    Raises:
        ...
        ValueError: If the input arguments are invalid.
    """
    return _get_messaging_service(app).send_each(messages, dry_run, use_http2)
...
class _MessagingService:
    ...
    def __init__(self, app):
        ...
        self._http2_client = _http_client.JsonHttpClient(credential=self._credential,
    ...
    def send_each(self, messages, dry_run=False, use_http2=False):
            ...
            try:
                if use_http2:
                    ...
                    resp = self._client.body(
                        ...
                        headers=self._fcm_headers,
                        json=data)
            except (requests.exceptions.RequestException, httpx.RequestError,
                    httpx.HTTPError, httpx.HTTPStatusError) as exception:
